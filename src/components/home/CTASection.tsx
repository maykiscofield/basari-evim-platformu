...
import { ArrowRight } from 'lucide-react'; // Sparkles sildim kanka
    ...
    <section className="py-28 relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* SINIRLI KONTENJAN: Sade, Asil ve Modern Görünüm */}
          <div className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-purple-600/10 to-purple-500/6 backdrop-blur-3xl border border-purple-500/30 rounded-full mb-12 shadow-[0_0_40px_rgba(168,85,247,0.25)] transition-all duration-500 group cursor-default transform hover:scale-105">
